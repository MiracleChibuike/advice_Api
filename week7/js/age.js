...
alert("Please enter your birth month and year")
    ...
    // alert("")
    display_Ans.textContent = "Invalid Month or year entered";
    ...
    display_Ans.textContent = `You are ${EvaLuate_Year} year(s) and
    ${Evauate_Month} month(s) old`;
    display_Ans.style.color = "#014001";
